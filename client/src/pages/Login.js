...
export default function Login() {
  ...
  return (
    <div className="pt-16 md:pt-20 pb-4 md:pb-6 min-h-screen flex items-center justify-center relative overflow-hidden">
      <div className="absolute inset-0 opacity-[0.04]">
        <div className="absolute top-1/4 left-1/3 w-96 h-96 bg-primary rounded-full blur-[150px] animate-pulse-glow" />
        <div className="absolute bottom-1/4 right-1/3 w-80 h-80 bg-primary-dark rounded-full blur-[120px]" />
      </div>
      ...
      <div className="max-w-md w-full mx-4 relative z-10">
        ...
        <motion.div initial={{ opacity: 0, scale: 0.95 }} animate={{ opacity: 1, scale: 1 }} transition={{ delay: 0.15 }} className="glass-strong rounded-3xl p-5 md:p-8 border border-primary/10">
          ...
          <Link to="/signup"
            ...
            <FiUserPlus size={16} /> Create Account <FiArrowRight className="group-hover:translate-x-1 transition-transform" size={14} />
          </Link>
        </motion.div>
      </div>
    </div>
